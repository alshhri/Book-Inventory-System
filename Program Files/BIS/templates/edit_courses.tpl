<div align="center">
	<table border="0" width="800" cellspacing="0" cellpadding="0">
		<tr>
			<td>
			<div align="center">
				<form method="POST" action="courses.php?go=editing&id={courses.code}">
					<p>&nbsp;</p>
					<table border="0" width="500" cellspacing="0" cellpadding="0">
						<tr>
							<td class="row2" height="24">Edit 
							Course:</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<input type="text" name="code" size="31" value="{courses.code}"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<option value="{isbn.ISBN}" <IF Name="{courses.book_ISBN} eq {isbn.ISBN}">selected </IF>>ISBN:{isbn.ISBN} &nbsp;/&nbsp;  Title:{isbn.title}</option>
							</LOOP>
							</select></td>
						</tr>
						<tr>
